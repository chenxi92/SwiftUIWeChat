...
class AudioRecorder: NSObject, ObservableObject {
    ...
    var recordingList: [Recording] = [] { didSet { saveRecordingData() } }
    
    var isRecording = false
    
    private var chat: Chat? = nil
    
    func startRecording(chat: Chat) {
        self.chat = chat
    ...
    func stopRecording() -> Recording? {
        ...
        var recording = Recording(fileURL: url, chatId: chat?.id ?? UUID())
